  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        leading: const SizedBox.shrink(), // AppBar의 기본 타이틀 공간을 없애기 위해 추가
      ...
      body: Obx(() {
        ...
        return Stack(
          ...
          children: [
            ...
            Container(color: Colors.black.withAlpha(75)), // 어두운 오버레이
            SafeArea(
              child: Padding(
              ...
              Row(
                children: [
                  ...
                  Text(
                    "시간별 예보 요약",
                    style:
                    textStyleMedium.copyWith(color: Colors.white),
                  ),
                ],
              ),
              verticalSpaceSmall,
